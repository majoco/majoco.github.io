...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Website development portfolio" />
    <style>
  ...
  <body>
	...
	<script>
	    ...
	    const raf = function (entry) {
	        document.requestAnimationFrame(entry);
	    };
	    ...
	    var app = {
	        ...
	        style: function () {
	            this.images.imagesLoaded(function () {
	                $(document).resize(function initial() {
	    ...
	    $(document).resize(function initial() {
	        document.addEventListener('mousemove', app.cursorEvents, false);
